...
function App() {
  ...
  const endTime = new Date("2023-04-17T12:00:00Z");
  ...
  const [feedback, setFeedback] = useState(`Click to mint your NEOGEMS.`);
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
              NEOGEMS brings together the sophistication of precious gemstones and the limitless potential of digital art.
            </s.TextDescription>
            ...
            >
              Within the NEOGEMS community, collectors come together in their appreciation for artistic ingenuity, innovation,
              and the mesmerizing appeal of these stunning digital treasures while also relishing in the exclusive future rewards and perks available solely to NEOGEMS holders.
            </s.TextDescription>
